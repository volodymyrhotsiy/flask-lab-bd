...
class Reservation(IDto, db.Model):
    ...
    reservation_history = relationship("ReservationHistory", backref="reservation", lazy=True)
    property_has_reservations = relationship("PropertyHasReservations", backref="reservation", lazy=True)
